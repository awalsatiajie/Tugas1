...
public class Hard extends Activity {
    ...
    List<QuestionHard> quesList;
    int score = 0;
    int qid = 0;


    QuestionHard currentQ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuizHelperHard db = new QuizHelperHard(this);
        ...
        Hard.CounterClass timer = new Hard.CounterClass(60000, 1000);
        timer.start();
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWERHARD().equals(AnswerString)) {
            ...
            Intent intent = new Intent(Hard.this,
        ...
        if (qid < 21) {
            ...
            Intent intent = new Intent(Hard.this,Won.class);
            Bundle b = new Bundle();
            b.putInt("score",score);
            intent.putExtras(b);
            startActivity(intent);
    ...
    private void setQuestionView() {
        ...
        txtQuestion.setText(currentQ.getQUESTIONHARD());
        button1.setText(currentQ.getOPTAHARD());
        button2.setText(currentQ.getOPTBHARD());
        button3.setText(currentQ.getOPTCHARD());
