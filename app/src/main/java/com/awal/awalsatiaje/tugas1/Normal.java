...
public class Normal extends Activity {
    ...
    List<QuestionNormal> quesList;
    int score = 0;
    int qid = 0;


    QuestionNormal currentQ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuizHelperNormal db = new QuizHelperNormal(this);
        ...
        Normal.CounterClass timer = new Normal.CounterClass(60000, 1000);
        timer.start();
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(Normal.this,
        ...
        if (qid < 21) {
            ...
            Intent intent = new Intent(Normal.this,Won.class);
            Bundle b = new Bundle();
            b.putInt("score",score);
            intent.putExtras(b);
            startActivity(intent);
